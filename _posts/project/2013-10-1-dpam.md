...
* Creating the integration between the Windows desktop application and Dynamics CRM by generating C# classes from Dynamic CRM entities (early-bind), and also creating the necessary repositories to consume in the desktop application.
