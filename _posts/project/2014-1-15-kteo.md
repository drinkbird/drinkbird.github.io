...
Each vehicle's representation image is constructed on the fly, depending on the vehicle's type, license plate, brand and color.
...
<ul class="list-inline gallery">
	<li>
		<a href="{{ site.baseurl }}/images/kteo_screen.jpg" class="image-popup mfp-with-zoom" title="Autovision's indoor advertising solution, displaying personalized automobile insurance offers to visiting customers. License plates have been blurred.">
			<img src="{{ site.baseurl }}/images/kteo_screen_150.jpg" alt="Autovision's indoor advertising solution, displaying personalized automobile insurance offers to visiting customers. License plates have been blurred." />
		</a>
	</li>
</ul>
