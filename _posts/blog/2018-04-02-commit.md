...
A prominent example is full stack web development, where you need to learn JavaScript to build your front-end, as well as one more language that who choose to build your back-end with[²](#ex2). Such an approach is challenging and more time-consuming than going after a single language, but it is viable as long as you pay an equal amount of attention on both ends.
