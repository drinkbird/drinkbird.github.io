...
It's all about results, and although perfectly reasonable, it doesn't mention anything about another - absolutely vital - ingredient of every single software project: *structural quality*.
...
We know that poor quality almost always stems from speed - the rush to produce something fast - taking numerous shortcuts along the way. The real question is, who's really responsible for keeping a project's structural quality high?

Let's expose some common misconceptions about software engineering and discuss your true role as an engineer.
...
# As an engineer you are a stakeholder of the system
...
Unfortunately most software startups have a very specific mindset that somehow urges them to write messy, inflexible software, as quickly as possible. It is as if they are competing at some race and have to get to the finish line first, whatever means necessary, leaving a huge trail of debris in their wake.
...
That mentality of rushing usually stems from the business side, as they keep trying to discover the right product to build. Although that's a legit concern, it should not affect the engineering side negatively. There are [proven techniques](http://blog.drinkbird.com/lean-startup-book-review/) for building a product incrementally, as a result of rapid experimentation, and engage with engineering only when necessary and in the right basis. That way there are no excuses for making a mess.
...
Remember, speed kills, it's the mother of all software defects. You can be all about results, but make sure that you don't just focus on behavior while letting the structure to rot, making up all kinds of excuses along the way.

This is not only unprofessional, but also leads to harming the business, the customers and the users. Don't be that guy.
