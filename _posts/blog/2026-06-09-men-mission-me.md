...
There is an ordering of a leader's priorities that I keep coming back to: *men, mission, me*. I learned it from James Broadhead, a mentor from earlier in my career, who had taken it in turn from the army, where the original is *the men* and the phrase had been worn smooth by long repetition. He told me even then that the wording was of its era and might not travel well, and he was right about that. I have kept the bones of it, because the meaning underneath has not aged a day. Read *men* as the people, all of them, whatever their gender.
...
This is the model I keep returning to in these essays, because it keeps proving itself. {% include link.html title="L. David Marquet's Turn the Ship Around" tag="turntheshiparound" %} describes the *leader-leader* alternative to command and control, where the leader's job is to clear the path so that the people closest to the work can own the decisions. It is the way I have tried to run my own team, where engineers bring decisions framed as *I intend to* rather than *what should I do*, and my job is to give that intent room rather than to gate it. {% include link.html title="Liz Wiseman's Multipliers" tag="multipliers" %} draws the same line from the opposite side: some leaders make everyone around them smarter and more capable, and some drain the room of judgment by needing to be its source. The first kind serves the team. The second has quietly put *me* back at the top of the list, usually without noticing.

Serving the team is also the only durable way to get the mission and the recognition you supposedly gave up by deordering them. A team that trusts its leader surfaces problems early, as I argued in [You can't threaten your way to effective engineering]({{ site.baseurl }}/psychological-safety/), and a team that surfaces problems early delivers things that actually work. {% include link.html title="Kim Scott's Radical Candor" tag="radicalcandor" %} calls the posture *care personally, challenge directly*, and the order of those two words is not accidental either. The care comes first, and it is what earns you the right to challenge hard without the challenge landing as a threat.
...
1. *The win and its cost never appear on the same slide.* If you can describe the delivery as a success without being able to say honestly what it cost the team, you have stopped counting the part of the ledger that *men first* is supposed to protect.
2. *Concerns reach you late and pre-softened, or not at all.* When people manage the risk of telling you something, the order has already tipped. I described this dynamic at length in [The decision everyone agreed with and no one believed]({{ site.baseurl }}/false-consensus/).
...
![the order seen from outside]({{ site.baseurl }}/images/man-mission-me-test.png)
...
The argument is narrower and, I think, harder. Recognition cannot be the target. The instant you aim at it directly, you corrupt the two things that actually produce it, the same way any metric stops being a good measure the moment it becomes the goal. Put the team first and deliver the mission through them, repeatedly, and the recognition arrives anyway, as a side effect, and it is the durable kind rather than the kind you have to keep manufacturing. {% include link.html title="Daniel Pink's Drive" tag="drive" %} makes a version of this point about motivation, that the deepest of it is a byproduct of autonomy, mastery and purpose rather than something you can pay for directly. Recognition for a leader works the same way. It is downstream of the order, and the order does not survive being skipped.

There is a sharper failure mode worth naming, and James, who gave me the phrase, no longer uses it for exactly this reason. *Me last* read as *me never* is its own inversion. The people who care most are the most exposed to it, because the order hands them a respectable-sounding reason to keep spending themselves, and a leader who treats their own rest and health as the slack the schedule can always borrow against is not serving the team. They are quietly burning down the one person the team counts on to clear its path. Self-care is not a competing priority that *me last* demotes but part of staying able to do the job at all. The order is a sound direction to lead by, but it is a direction and not an absolute. The moment it has you running yourself empty, you have overdone a good thing.
...
Men, mission, me. The order is not a slogan but the actual job description.
