...
The book is a long, patient walkthrough of techniques to get behaviour under test in codebases that were never designed for testability. The "seams" concept (places where you can alter behaviour without editing the surrounding code) is the central tool, and once you have the vocabulary you start spotting seams everywhere.
