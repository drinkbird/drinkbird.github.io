Eric Evans' DDD is one of those books whose ideas have so thoroughly permeated the industry that people use the vocabulary (bounded context, aggregate, ubiquitous language) without realising where it came from.
