Chris Richardson's pattern catalogue for microservices, covering the lifecycle from initial decomposition through API design, data management, deployment, and observability. Each pattern includes the trade-offs and the failure modes, not just the happy-path implementation.
