...
|---|---|---|
| Expecting content edits to appear without a rebuild. | The HTML was rendered at the last build; new posts don't materialize on their own. | Run `jekyll build` (locally) or push to GitHub (Pages auto-rebuilds). |
