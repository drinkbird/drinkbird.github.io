---
chapter_id: 5
chapter_slug: continued-learning-roadmap
chapter_title: "Continued learning roadmap"
chapter_summary: "Provides a curated reading list (canonical books, newsletters, podcasts, S-1s/10-Qs, shareholder letters) and a sustainable monthly/quarterly learning cadence. Closes the course by reframing it as the foundation layer rather than an endpoint."
---
...
```mermaid
flowchart TD
  course[This course: foundation] --> canon[Canonical books: Porter, Christensen, Helmer, Grove]
  course --> ongoing[Newsletters: Stratechery, The Diff, Lenny]
  course --> filings[S-1s, 10-Ks, shareholder letters]
  canon --> intuition[Built-up intuition]
  ongoing --> intuition
  filings --> intuition
  intuition --> apply[Apply at work]
  apply --> compound[Compound benefit over years]
```
