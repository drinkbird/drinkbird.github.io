---
chapter_id: 3
chapter_slug: reading-exec-reviews
chapter_title: "Reading & contributing in exec reviews"
chapter_summary: "Covers QBR mechanics, board-deck reading, the role of pre-meetings, when to interject, and how to read the room. Emphasises that QBRs ratify decisions formed in pre-meetings - not the other way around."
---
...
```mermaid
flowchart LR
  prereads[Pre-reads distributed] --> premeet[Pre-meetings: align positions]
  premeet --> qbr[QBR: surface and ratify decisions]
  qbr --> followup[Follow-ups: coordinate execution]
  followup --> next[Inform next quarter's plan]
  decisions[Decisions get made] -.-> premeet
  decisions -.-> qbr
```
